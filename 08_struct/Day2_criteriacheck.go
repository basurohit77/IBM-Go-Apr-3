...
func main() {
	...
	*/
	/*
		var p1 Product = Product{100, "Pen", 10, 200, "Stationary"} // constructor type initialisation
	*/
	/*
	...
	*/
	...
	grapes := NewPerishableProduct(101, "Grapes", 80, 50, "Fruits", 2)  // like constructor
